# nomad_tabular_parser_extended

extended tabular parser
...
```sh
git clone https://github.com/FAIRmat/nomad_tabular_parser_extended.git
cd nomad_tabular_parser_extended
...
nomad_tabular_parser_extended==x.y.z
```
...
```sh
pip install dist/nomad_tabular_parser_extended-1.0.0
```
